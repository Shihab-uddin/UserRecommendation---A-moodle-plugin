 ...
 *
 * @package    report_userrecommendation
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'report_userrecommendation');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, "admin", "report userrecommendation", "report/userrecommendation/index.php?qtype=$requestedqtype", $requestedqtype);
    }
    ...
    public function get_url() {
        return new \moodle_url('/report/userrecommendation/index.php', array('qtype' => $this->other['requestedqtype']));
    }
